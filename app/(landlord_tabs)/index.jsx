...
export default function LandlordDashboardScreen() {
  ...
  const [income] = useState(5250.75);
  const [expenses] = useState(1105.30);
  const [rentDue] = useState(850.0);
  ...
  const handleGoToChat = () => {
    router.push("/chat"); // ensure this matches your chat screen path
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        >
          <Text style={styles.moreAnalyticsText}>
