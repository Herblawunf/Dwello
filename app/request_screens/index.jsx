...
export default function ChatScreen() {
  ...
  const { requestId, description, tenant, landlord } = useLocalSearchParams();
  const {
    state: { userId, userRole },
  } = useContext(AuthContext);

  // Get the other party's name based on user role
  const otherPartyName = userRole === "landlord" ? tenant : landlord;
    ...
    >
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          ...
          <Text style={styles.subtitle}>{otherPartyName}</Text>
        </View>
      </View>
